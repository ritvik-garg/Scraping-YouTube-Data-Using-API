...
# create a CSV output for video list    
  ...
  csvWriter.writerow(["title","videoId","viewCount","likeCount","dislikeCount","commentCount","favoriteCount","publishedAt"])
      ...
      if search_result["id"]["kind"] == "youtube#video":
        #videos.append("%s (%s)" % (search_result["snippet"]["title"],search_result["id"]["videoId"]))
          ...
          for video_result in video_response.get("items",[]):
              ...
              """if 'publishedAt' not in video_result["statistics"]:
                publishedAt = 0
              else:
                publishedAt = video_result["statistics"]["publishedAt"]"""
